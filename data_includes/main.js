...
// Interference phase 
PennController.Template("InterferenceCond2.csv", row=>
newTrial("InterferenceCond2",
    //noTopMargin(),
    ...
    ,
    newCanvas( 'Interference2', "90vw", "80vh")
    .add( "25vw", "0vh", getImage("bubble"), 0 )
    .add( "35vw", "32vh", getImage("Alien"), 1 )
    .add( "28vw", "7vh", getText("word"), 2 )
    .add( "45vw", "1vh", getImage("item"), 3 )
...
// // // // // //InterferenceCon1b
// // // PennController.Template("InterferenceCond1b.csv", row=>
// // // newTrial("InterferenceCond1b",
...
// // //     ,
// // //     newCanvas( 'Interference1a', "90vw", "80vh")
// // //     .add( "25vw", "0vh", getImage("bubble"), 0 )
// // //     .add( "35vw", "32vh", getImage("Alien"), 1 )
// // //     .add( "28vw", "7vh", getText("word"), 2 )
// // //     .add( "45vw", "1vh", getImage("item"), 3 )
...
// // // // //InterferenceCon3
// // // PennController.Template("InterferenceCond3.csv", row=>
// // // newTrial("Interference",
...
//Testing phase
//Suffix selection
PennController.Template("TestQ2.csv", row=>
...
PennController.Template("TestQ1.csv", row=>
